...
download_from_dist() {
    ...
    local config_example_url="${GITHUB_PROXY}/https://raw.githubusercontent.com/${REPO}/main/configs/config.example.yaml"
    local env_example_url="${GITHUB_PROXY}/https://raw.githubusercontent.com/${REPO}/main/configs/.env.example"
